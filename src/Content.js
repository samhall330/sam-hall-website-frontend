...
<div class= "content-list">
    <h1>Hot Bits!</h1>
        ...
        <br></br>
        <h5>Mascara is Over Sexualized - 2020 (Writer, Editor)</h5>
    <br></br>
    <h1>Series</h1>
        ...
        <br></br>
        <h5>Great Interracial Baking Show - Episode 1 "Introductions" - 2020 (Actor, Producer, Editor)</h5>
    <br></br>
        ...
        <br></br>
        <h5>Great Interracial Baking Show - Episode 2 "Buttered Toast" - 2020 (Producer, Editor)</h5>
    <br></br>
        ...
        <br></br>
        <h5>Great Interracial Baking Show - Episode 3 "Caucasian Cornbread" - 2020 (Actor, Producer, Editor)</h5>
    <br></br>
    <h1>Short Shorts</h1>
        ...
        <br></br>
        <h5>"Scary Toilet" - 2020 (Producer, Director, Editor)</h5>
    <br></br>
        ...
        <br></br>
        <h5>"Mum Fights" - 2021 (Producer, Actor, Director, Editor)</h5>
    <br></br>
    <h1>Acting!</h1>
        ...
        <br></br>
        <h5>"Horror Derves - Episode 1 - What Doesn't Kill You Makes You Stranger" - 2021 (Actor- "Mom")</h5>
    <br></br>
</div>
