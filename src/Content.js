...
<div className= "content-list">
    ...
    <h1>Series</h1>
        <a href="https://www.instagram.com/tv/CDj43MyAUds/">
            <img className="content-links" src={gibs1} alt="the great interracial baking show episode 1" width="600" height="300"></img>
        </a>
        <br></br>
    ...
    <br></br>
        <a href="https://www.instagram.com/tv/CEsK902Dy8A/">
            <img className="content-links" src={gibs2} alt="the great interracial baking show episode 2" width="600" height="300"></img>
        </a>
        <br></br>
    ...
    <h1>Short Shorts</h1>
        <a href="https://www.instagram.com/p/CFsyxtoAv1j/">
            <img className="content-links" src={scary} alt="a comedy short film called Scary Toilet" width="600" height="300"></img>
        </a>
        <br></br>
        <h5 className="content-caption">"Scary Toilet" - 2020 (Producer, Director, Editor)</h5>
    <br></br>
        <a href="https://www.instagram.com/p/CMaGliqA_LY/">
            <img className="content-links" src={mumfights} alt="a comedy sketch called Mum Fights" width="600" height="300"></img>
        </a>
        <br></br>
    ...
    <h1>Acting!</h1>
        <a href="https://www.youtube.com/watch?v=p6YyimoY47Y&ab_channel=HaleynaKociuk-Garza">
            <img className="content-links" src={stranger} alt="Horror Derves Episode 1" width="600" height="300"></img>
        </a>
        <br></br>
